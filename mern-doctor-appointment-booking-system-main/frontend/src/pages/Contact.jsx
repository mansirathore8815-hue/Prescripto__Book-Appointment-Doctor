...
const Contact = () => {
  const handleExploreJobs = () => {
    // Open LinkedIn jobs or general job portal
    window.open('https://www.linkedin.com/jobs/search/?keywords=healthcare%20jobs', '_blank');
  };
      ...
      <div className="my-10 flex flex-col md:flex-row gap-10 justify-center mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center gap-6 items-start">
          ...
          <button 
            ...
            className="border border-primary text-primary px-8 py-4 text-sm hover:bg-primary hover:text-white transition-all duration-500 cursor-pointer active:scale-95"
          >
            Explore Jobs
          </button>
        </div>
